...
# unlicensed omnitruck.chef.io host (see chef_download_host in chef-install.psm1).
...
function Write-LicenseKeyStatus($licenseKey) {
  if (-Not $licenseKey) {
    Write-Warning "[$(Get-Date)] WARNING: No chef_license_key provided. Omnitruck is being shut down - unlicensed downloads will stop working in the near future."
